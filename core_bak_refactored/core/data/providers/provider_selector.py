...
if TYPE_CHECKING:
    from core_bak_refactored.core.data.providers.protocols import HistoricalDataProvider

logger = logging.getLogger('DeepSeekQuant.ProviderSelector')


class ProviderSelector:
    """数据源选择服务
    
    根据 symbol/market 选择合适的数据提供者
    """
