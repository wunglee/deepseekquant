...
- 文件名保留 `assertions_test.py` 是为了保持命名一致性
- 该工具类本身的单元测试位于：tests/units/common/test_assertions_test.py

注意：
- 本文件 **不包含测试用例**（pytest 会收集 0 个测试）
- 仅提供断言方法供其他测试文件调用
- 使用示例参见各方法的 docstring
"""
