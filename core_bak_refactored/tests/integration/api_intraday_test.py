...
class IntradayAPITest(unittest.TestCase):
    ...
    def test_api_returns_400_when_data_incomplete(self):
        ...
        with patch('core_bak_refactored.core.data.providers.akshare_provider.AKShareDataProvider') as MockProvider:
            ...
            # 冻结时间到盘后
            with patch('core_bak_refactored.core.data.providers.akshare_provider.dt') as mock_dt:
