...
def add_unregister_method():
    ...
    # 动态添加方法
    setattr(ProcessorOrchestrator, "unregister_processor", unregister_processor)  # type: ignore[attr-defined]
    setattr(ProcessorOrchestrator, "cleanup_all", cleanup_all)  # type: ignore[attr-defined]
...
class TestProcessorOrchestrator(unittest.TestCase):
    ...
    def setUp(self):
        self.manager = ProcessorOrchestrator()
